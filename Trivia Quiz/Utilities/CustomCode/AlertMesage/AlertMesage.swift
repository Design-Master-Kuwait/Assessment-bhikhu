...
class AlertMesage: NSObject {
    public class func show(_ theme: Theme, title: String? = nil, message: String?, duration: Int  = 2) {
        ...
        switch theme {
        case .info:
            view.configureTheme(backgroundColor: UIColor.blue, foregroundColor: .white, iconImage: iconStyle.image(theme: .info), iconText: nil)
            view.titleLabel?.text = "Info"
            
        case .success:
            view.configureTheme(backgroundColor: UIColor.green, foregroundColor: .white, iconImage: iconStyle.image(theme: .warning), iconText: nil)
            view.iconImageView?.image = view.iconImageView?.image!.withRenderingMode(.alwaysTemplate)
            view.iconImageView?.tintColor = UIColor.green
        ...
        case .error:
            ...
            view.configureTheme(backgroundColor: UIColor.red, foregroundColor: .white, iconImage: iconStyle.image(theme: .error), iconText: nil)
